...
import chat from '../assets/favicon.svg'
import menu_icon from '../assets/menu_icon.png'
import { useNavigate } from 'react-router-dom'
import search_icon from '../assets/search_icon.svg'
import assets, {userScriptData} from '../assets/assets.js'
...
const SideBar = ({selectedChat, setSelectedChat}) => {
  ...
  <div className={`bg-[#818582]/10 h-full p-5 rounded-r-xl overflow-y-scroll
    text-white ${selectedChat ? 'max-md:hidden' : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
            <img src={chat} alt="logo" className='max-w-10' />
