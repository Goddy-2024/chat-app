...
import assets, { messagesScriptData } from '../assets/assets'
              ...
              ${msg.senderId !== '680f50e4f10f3cd28382ecf9' && 'flex-row-reverse'}`}>
                {msg.image ? (
                  ...
                  <p className={`p-2 max-w-[200px] md:text-sm font-light
                    rounded-lg mb-8 break-all bg-blue-500/30 text-white 
...
Bottom input Section
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
      ...
      <p className='text-lg font-medium text-white'>Chat Instantly anytime, anywhere</p>
    </div>
  )
}
