...
import assets, { imagesScriptData } from '../assets/assets'
    ...
    <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll
     ${selectedChat ? "max-md:hidden" : ""}`}>
      ...
      <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'> 
        {/*The div that holds the Selected chat profile and bio*/}
        
        <img src={selectedChat?.profilePic || assets.avatar_icon} alt=""
      ...
      <div className='px-5 text-xs'>
        ...
        <div className='mt-2 max-h-[200px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80'>
          {imagesScriptData.map((url, index)=>(
      ...
      bg-gradient-to-r from-blue-400 to-blue-1000 text-white border-none text-sm
