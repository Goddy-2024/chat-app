...
const ProfiePage = () => {
  ...
  const [name, setName] = useState("Lucky Omondi");
  const [bio, setBio] = useState("Hi Everyone, I'm using Instant App");
  ...
  return (
    ...
    justify-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-white border-2
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          focus:ring-blue-500' rows={4}></textarea>

          <button type='submit' className='bg-gradient-to-r from-purple-400
          to-blue-600 text-white p-2 rounded-full text-lg cursor-pointer'>Save</button>
        </form>
