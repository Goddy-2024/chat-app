...
export const signup = async (req, res)=>{
    ...
    try {
        ...
        res.status(200).json({success: true, userData: newUser, token, message: "Account Creation Success"});
        }
    catch (error) {
...
export const login = async(req, res)=>{
    try {
        ...
        res.status(200).json({success: true, userData: newUser, token, message: "Login Success"});
    } catch (error) {
